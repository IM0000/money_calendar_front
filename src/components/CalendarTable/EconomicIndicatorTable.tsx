      ...
      <table className="min-w-full table-fixed divide-y divide-gray-200">
        ...
        <thead className="calendar-table-header sticky top-0 z-30 bg-gray-50">
          <tr className="h-[2.80rem]">
            ...
            <th className="w-[110px] min-w-[140px] px-5 py-2 text-right text-sm font-medium text-gray-700">
              실제
            </th>
            <th className="w-[110px] min-w-[140px] px-5 py-2 text-right text-sm font-medium text-gray-700">
              예측
            </th>
            <th className="w-[110px] min-w-[120px] px-5 py-2 text-right text-sm font-medium text-gray-700">
              이전
            </th>
          </tr>
        </thead>
...
function EconomicIndicatorRow({
  ...
  return (
    <tr className="relative">
      ...
      <td className="px-5 py-2 text-right text-sm font-bold text-gray-700">
        {indicator.actual}
      </td>
      <td className="px-5 py-2 text-right text-sm text-gray-700">
        {indicator.forecast}
      </td>
      <td className="px-5 py-2 text-right text-sm text-gray-700">
        {indicator.previous}
