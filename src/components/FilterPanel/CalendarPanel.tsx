    ...
    <div className="w-screen max-w-full">
      ...
      {showCards && (
        <div className="relative">
          ...
          {showScrollButtons && (
            <button
              className="absolute left-0 top-1/2 z-10 -translate-y-1/2 transform rounded-full bg-gray-200 p-2 shadow-md"
              onClick={scrollLeft}
            >
          ...
          {showScrollButtons && (
            <button
              className="absolute right-0 top-1/2 z-10 -translate-y-1/2 transform rounded-full bg-gray-200 p-2 shadow-md"
              onClick={scrollRight}
            >
